...
BLOG_AUTHOR = "Chris George"  # (translatable)
BLOG_TITLE = "Chris George"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.chrisgeorge.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.chrisgeorge.ca/"
BLOG_EMAIL = "technatica@gmail.com"
BLOG_DESCRIPTION = "It is all writing."  # (translatable)
...
NAVIGATION_LINKS = {
            ...
            ('https://twitter.com/ItisChrisGeorge', 'My Twitter', 'fab fa-twitter'),
            ('https://github.com/technatica', 'My Github', 'fab fa-github'),
}
